...
# The script uses pyyaml via uv inline metadata, but the project venv
# doesn't include it.  Provide a stub so the module-level `import yaml`
# succeeds — ensure_base_permissions never calls yaml functions.
